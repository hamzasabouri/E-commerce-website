...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `produit` SET `name`='$name', `price`='$price', `description`='$description', `type`='$type', `pic`='$product_image' WHERE `id`=$id";
...
<input type="file"  accept="image/*"  name="product_image"  required>
  ...
  <label>
          <input required="" placeholder="" type="text" class="input"id="price" name="price"value="<?php echo $row['price'] ?>">
          <span>Prix</span>
      </label>
